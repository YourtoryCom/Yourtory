    ...
    <div className="app">
      <header className="header">
        <a href="https://corp.yourtory.com/" target="_blank" rel="noopener noreferrer" className="logo-link">
          <img src={`${base}logo-mark.png`} alt="Yourtory Logo" className="logo-mark" />
        </a>
      </header>
      <div className="title-container">
        <img src={`${base}title-yourtory.png`} alt="Yourtory" className="main-title" />
      ...
      <div className="products-container">
        <div className="product-item">
          <a href="https://torynvas.yourtory.com/" target="_blank" rel="noopener noreferrer" className="product-link">
            <img src={`${base}product-torynvas.png`} alt="Torynvas" className="product-logo product-logo-torynvas" />
          </a>
        ...
        <div className="product-item">
          <a href="https://torync.yourtory.com/" target="_blank" rel="noopener noreferrer" className="product-link">
            <img src={`${base}product-torync.png`} alt="Torync" className="product-logo product-logo-torync" />
          </a>
        ...
        <div className="product-item">
          <a href="https://fintory.yourtory.com/signin" target="_blank" rel="noopener noreferrer" className="product-link">
            <img src={`${base}product-fintory.png`} alt="Fintory" className="product-logo product-logo-fintory" />
          </a>
        ...
        <div className="product-item">
          <a href="https://dettory.yourtory.com/" target="_blank" rel="noopener noreferrer" className="product-link">
            <img src={`${base}product-dettory.png`} alt="Dettory" className="product-logo product-logo-dettory" />
          </a>
